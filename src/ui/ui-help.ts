...
export const UI_ELEMENTS: UiElementDoc[] = [
  ...
  },
  {
    ...
    what: [
      ...
      '**Goal** — open/close the right teaching panel.',
      '**Hint** — one-line + remaining solution steps.',
      ...
      '**Help** — this page (also `help ui`).',
    ].join('\n'),
    how: 'Prefer typing in the terminal; buttons are shortcuts.',
  },
  {
    id: 'status-pills',
    selector: '.status-bar',
  ...
  },
  {
    id: 'dock',
    selector: '.dock',
    title: 'Right panel (Goal / learning)',
    what: [
    ...
    how: 'Keep this open while learning (`show goal`). Do not jump to solution until stuck.',
  },
  {
    id: 'term-log',
    selector: '.term-log',
